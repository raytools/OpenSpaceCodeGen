namespace OpenSpaceCodeGen.AITypes {
    public partial class AIType {
        ...
        public static AIType Largo = new AIType()
        {
            #region Keywords
            ...
            NodeTypes = new NodeType[] {
				...
				NodeType.ModelRef, // different type though
				NodeType.CustomBits,
                NodeType.Caps,
                NodeType.Unknown,
                NodeType.SubRoutine, // 40
				NodeType.Null,
                NodeType.Null,
                NodeType.Unknown
            }
